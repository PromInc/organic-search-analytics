## 2.5.4 - 2017-05-25
### Bug Fixes
- Revert unintentional deployment of Apache Alias environment proposed in #31 and tracked in #38 and deployed in version 2.5.0 which issues with the report pages.
